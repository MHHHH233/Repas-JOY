...
class AdminLandingSectionController extends Controller
{
    /**
     * Display a listing of landing sections (Admin only)
     */
    ...
    /**
     * Store a newly created landing section (Admin only)
     */
    ...
    /**
     * Display the specified landing section (Admin only)
     */
    ...
    /**
     * Update the specified landing section (Admin only)
     */
    ...
    /**
     * Remove the specified landing section (Admin only)
     */
    ...
    /**
     * Get landing section statistics (Admin only)
     */
    public function getStats()
    {
        $total = LandingSection::count();
        $active = LandingSection::where('is_active', true)->count();
